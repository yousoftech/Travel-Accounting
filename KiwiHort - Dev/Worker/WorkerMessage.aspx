    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-4 col-xs-4">
                <asp:LinkButton ID="Compose" Style="min-width: 95px;" runat="server" CssClass="btn btn-block btn-success" OnClick="Button1_Click"><i class="ion ion-ios-navigate-outline"></i>&nbsp;&nbsp;Compose</asp:LinkButton>
            </div>
            <div class="col-sm-4 col-xs-4">
                <asp:LinkButton ID="Button2" Style="min-width: 85px;" CssClass="btn btn-block btn-warning" runat="server" OnClick="Button2_Click"><i class="fa fa-inbox"></i>&nbsp;&nbsp;Inbox</asp:LinkButton>
            </div>
            <div class="col-sm-4 col-xs-4">
                <asp:LinkButton ID="Button3" Style="min-width: 85px;" CssClass="btn btn-block btn-danger" runat="server" OnClick="Button3_Click"><i class="fa fa-envelope-o"></i>&nbsp;&nbsp;Sent</asp:LinkButton>
            </div>
        </div>
        <br />
        <div class="row">
