<%@ Page Title="" Language="C#" MasterPageFile="~/Monitor/MonitorMaster.master" AutoEventWireup="true" CodeFile="MonitorReport.aspx.cs" Inherits="Monitor_MonitorReport" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_mainSection" runat="Server">

    <%--Report1, 2 , 3 code starts Here--%>
                            ...
                            <asp:View ID="View1" runat="server">
                                ...
                                <div id="startTimesContent" class="times-content" runat="server">
                                    <div class="table-responsive">
                                        ...
                                        <br />
                                        <asp:Button ID="btn_search" runat="server" Text="Search" CssClass="btn btn-primary pull-right" OnClick="btn_search_Click" />

                                        <asp:Label ID="lblError" class="has-error" runat="server"></asp:Label>

                                    </div>
                                    <div>

                                        <asp:GridView ID="gvdatadisply" runat="server" CssClass="table table-hover"></asp:GridView>
                                    </div>
                                </div>
                            </asp:View>
                        </div>
